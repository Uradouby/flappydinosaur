...
//  flappydinasour
//
//  Created by 181860025 on 2020/12/3.
//  Copyright © 2020 181860025. All rights reserved.
//
...

{
    ...
    func creatBird(){
        ...
        for j in 1..<4 {
            let image = UIImage(named: String(format: "bird%d", j))
    ...
    func creatWood(){
        let image:UIImage = UIImage(named: "04")!
        let image2:UIImage = UIImage(named: "05")!
    ...
    func gameOver(){
        ...
        gameOver.image=UIImage(named: "gameover2")
        gameOver.tag=900
